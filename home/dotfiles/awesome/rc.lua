...
local function wallpaperCycle()
    -- Wallpaper
    awful.spawn.easy_async_with_shell("feh --bg-fill --randomize ~/Pictures/wallpapers/*")
...
local volumeNotification = function()
...
globalkeys = gears.table.join(
    ...
    awful.key(
        ...
        {description = "PrintScreen", group = "PrintScreen"}),



    awful.key(
        {modkey, "Shift"}, "KP_Add", function()
                awful.spawn.with_shell("sct")
        end,
        {description = "Default screen temperature", group = "Temperature"}),

    awful.key(
        {modkey, "Shift"}, "KP_Subtract", function()
                awful.spawn.with_shell("sct 3700")
        end,
        {description = "3700 screen temperature", group = "Temperature"}),
